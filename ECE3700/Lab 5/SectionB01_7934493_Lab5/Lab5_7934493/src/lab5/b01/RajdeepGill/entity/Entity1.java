...
public class Entity1 extends Entity {
    ...
    public Entity1() {
        ...
        distanceTable[0][0] = 1; // from 1 to 0 via 0
        distanceTable[1][1] = 0; // self
        distanceTable[2][2] = 1; // from 1 to 2 via 2   
        ...
        Packet to_p0 = new Packet(1, 0, minCosts);
        Packet to_p2 = new Packet(1, 2, minCosts);
